        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{ height: this.state.heigthmapview }}>
                         <MapViewComponent data={this.state.mang} goDetails={this.goDetails.bind(this)} bankinh={global.bankinhsearch * 1000} loadData={this.loadData2.bind(this)} />
                        {/* <MapViewComponent /> */}
                </View>
